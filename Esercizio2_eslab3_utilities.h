...
private:
	...
	string city;
public:
	Item(string s = "", string c = "") {
		sigle = s;
		city = c;
	}
	string get_s() const { return sigle; }
	string get_c() const { return city; }
};
...
inline ostream& operator<<(ostream& os, const Item& it) { return os << "(" << it.get_s() << ", " << it.get_c() << ")"; }
